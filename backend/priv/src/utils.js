...
import Logger, { logUnderControl as logUnderCtrl, addNextLineToLog as addNextLn } from "../../src/Logger.js"
...
export function randomString( numbersCount = 10, charsCount = 6, upperCase = 2, specialChar = 2 ) {
  ...
  if (passwLen < charactersCount) [ passwLen, charactersCount ] = [ charactersCount  ]
