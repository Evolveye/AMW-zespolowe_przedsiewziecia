...
export const ANSWERS = { // error - success
  ...
  EMAIL_ALREADY_EXISTS:            { code:124, error:`User with provided email already exists.` },

  LOGIN_HAS_BEEN_CHANGED: { code:125, success:`Your login has been properly assigned.` },
  ACCTIVATE_DATA_MISS: { code:126, error:`Acctivation-code or login has been not provided.` },
  SUCCESS_EDIT: { code:127, success:`Edited successfully` },
  UPDATE_USER_NO_CHANGES:{ code:128, error:`Nothink to update.` },
  UPDATE_PASSWORD_OLD_DIFF:{ code:129, error:`Change password refused - Provided account password is not correct.` },
  LOGIN_ALREADY_IN_USE:{ code:130, error:`Login is already in use.` },
  ACCTIVATION_PROCCESS_EXPIRED:{ code:131, error:`Acctivation process has been exipred.` },
  PASSWORD_RESET_NEW_PASSW_NOT_SAME:{ code:132, error:`new passwords are not the same` },
}
