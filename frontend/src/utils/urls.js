...
const URLS = {
  ...
  GROUP$ID_NOTES_POST: groupId => `${HOST}/api/groups/${groupId}/notes`,
  GROUP$ID_NOTES_GET: groupId => `${HOST}/api/groups/${groupId}/notes`,
  GROUP$ID_NOTES$ID_PUT: noteId => `${HOST}/api/groups/notes/${noteId}`,
  GROUP$ID_PERMISSIONS_GET: groupId => `${HOST}/api/groups/${groupId}/permissions`,
  ...
  GROUPS$ID_FILE_POST: groupId => `${HOST}/api/groups/${groupId}/materials`,
  GROUPS$ID_FILE_GET: groupId => `${HOST}/api/groups/${groupId}/materials`,
  GROUPS$ID_FILE_DELETE: (groupId, materialId) => `${HOST}/api/groups/${groupId}/materials/${materialId}`,
  GROUPS$ID_TASKS_POST: groupId => `${HOST}/api/groups/${groupId}/tasks`,
  GROUPS$ID_TASKS_GET: groupId => `${HOST}/api/groups/${groupId}/tasks`,
  GROUPS$ID_TASKS_DELETE: (groupId, taskId) => `${HOST}/api/groups/${groupId}/tasks/${taskId}`,
  GROUPS$ID_TASKS_DONE_POST: (groupId, taskId) => `${HOST}/api/groups/${groupId}/tasks/${taskId}/done`,
  GROUPS$ID_TASKS_DONE_GET: (groupId, taskId) => `${HOST}/api/groups/${groupId}/tasks/${taskId}/done`,
  GROUP$ID_GRADINGSCALE_PUT: groupId => `${HOST}/api/groups/${groupId}/scale`,
