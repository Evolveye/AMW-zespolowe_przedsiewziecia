...
const PlatformSettigs = () => { 
    ...
    <div className="right-container-profile-left">
      ...
      <div className="subjects-list">
        <div className="subject"> 
          <div className="subject-name"><Link to="/platformsGeneral/">Ogólne</Link></div>
        </div>
        <div className="subject"> 
        ...
        <div className="subject"> 
          <div className="subject-name"><Link to="/platformGroups/">Grupy</Link></div>
        </div>
    ...
    <div className="right-container-profile-left-text">
      ...
      <div className="subjects-list">
        <div className="subject">
          ...
          <div className="subject-name"><Link to="/groups/">Przedmiot 1</Link></div>
        </div>
        <div className="subject">
          <div className="subject-icon"></div>
  ...
  export default PlatformSettigs