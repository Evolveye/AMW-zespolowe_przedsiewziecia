  ...
  <div className="right-container-settings">
    <div className="settings-header">
      ...
      <div className="back-main-view">
        <span onClick={this.goBack} onKeyDown={this.goBack} role="button" tabIndex="0">Powrót do widoku głównego</span>
      </div>
    </div>
      ...
      <form>
        ...
        <div className="settings-form-element">
          ...
          <div className="settings-form-element-input settings-form-element-button">
            <input type="button" name="loginMergeRequest" value="Skanuj" />
          </div>
        </div>
      </form>
    </div>
