                ...
                <div className="grid-filtre">
                    <div class="filtre-add-user-wrapp">
                        ...
                        <div class="grades-gained-container-grid-new-row">
                            ...
                            <div class="grid-item  imie border-bottom-none"><input type="text" name="" placeholder="Wpisz..." /></div>
                            <div class="grid-item nazwisko border-bottom-none"><input type="text" name="" placeholder="Wpisz..." /></div>
