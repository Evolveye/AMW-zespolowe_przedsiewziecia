...
describe("Test ID: T-4-7", () => {
  it(dane.platforma_dodawanie_uzytkownika.t4_7.testName, () => {
    ...
    if(dane.platforma_dodawanie_uzytkownika.t4_7.imie != ""){
        cy.get(':nth-child(1) > .platformChooser-module--adder--3Q9wM').type(dane.platforma_dodawanie_uzytkownika.t4_7.imie)
    }else{
        cy.get(':nth-child(1) > .platformChooser-module--adder--3Q9wM').invoke('val', "")
    }

    if(dane.platforma_dodawanie_uzytkownika.t4_7.nazwisko != ""){
        cy.get(':nth-child(2) > .platformChooser-module--adder--3Q9wM').type(dane.platforma_dodawanie_uzytkownika.t4_7.nazwisko)
    }else{
        cy.get(':nth-child(2) > .platformChooser-module--adder--3Q9wM').invoke('val', "")
    }

    if(dane.platforma_dodawanie_uzytkownika.t4_7.email != ""){
        cy.get(':nth-child(3) > .platformChooser-module--adder--3Q9wM').type(dane.platforma_dodawanie_uzytkownika.t4_7.email)
    }else{
    ...
    cy.contains(dane.platforma_dodawanie_uzytkownika.t4_7.error)
