...
describe("Test ID: T-4-3", () => {
  it(dane.platforma_tworzenie.t4_3.testName, () => {
    ...
    cy.get('form > input').type(dane.platforma_tworzenie.t4_3.nazwa)
    cy.get('form > .neumorphizm').click()
    cy.contains(dane.platforma_tworzenie.t4_3.error)
