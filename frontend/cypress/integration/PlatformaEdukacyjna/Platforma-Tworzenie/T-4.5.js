...
describe("Test ID: T-4-5", () => {
  it(dane.platforma_tworzenie.t4_5.testName, () => {
    ...
    cy.get('form > input').type(dane.platforma_tworzenie.t4_5.nazwa)
    cy.get('form > .neumorphizm').click()
    cy.contains(dane.platforma_tworzenie.t4_5.error)
